...
namespace Mango.Cache.Interface
{
    public interface ICacheManager : System.IDisposable
    {
        ...
        void AddOrUpdate(string key, object value, TimeSpan expires, CacheEntryRemovedCallback CacheEntryEvictedCallback);
        ...
        /// <param name="value">cache object</param>
        /// <param name="CacheEntryEvictedCallback">delegate callback action when a cache entry is evicted</param>
        void AddOrUpdate(string key, object value, CacheEntryRemovedCallback CacheEntryEvictedCallback);
        ...
        void AddOrUpdatePermanently(string key, object value);
